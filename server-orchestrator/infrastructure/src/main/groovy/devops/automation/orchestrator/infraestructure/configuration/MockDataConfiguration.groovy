...
class MockDataConfiguration {
    ...
    private static User[] users() {
        def securityContext = new SecurityContext(roles: [new Role(name: EnumRole.ADMIN)] as Set, reviewers: [])
        return [new UserApp(id: '1',
                name: 'rubentxu',
    ...
    private static AutomatedTask[] tasks() {
        new AutomatedTask[]{
    ...
    void loadData() {
        println("Load data AutomatedTask")
